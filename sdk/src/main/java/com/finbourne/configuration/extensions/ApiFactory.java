...
/**
* Utility class that builds pre-configured configuration API instances to access configuration.
*
*/
public class ApiFactory {
    ...
    /**
    * The unique package that hosts all the configuration API classes
    */
    ...
    */
    ...
    /**
    * Builds an instance of a configuration API 
    *
    * For each instance of an {@link ApiFactory} only a singleton instance of each configuration API class exist. The APIs
    * are lazily initialised on request.
    *
    *
    * @param apiClass - class of the configuration API to create
    * @param <T> configuration API type
    * @return instance of the configuration API type configured as per the {@link ApiClient}
    *
    ...
    */
    ...
    /*
    * Create an instance of a configuration API configured by an {@link ApiClient}
    *
    * @throws UnsupportedOperationException on any reflection related issues on constructing the configuration API object
    */
    ...
    /*
    * Retrieves the constructor for the configuration API that accepts an {@link ApiClient}
    *
    * @throws UnsupportedOperationException if the class doesn't have a valid constructor that takes
    * an {@link ApiClient} as an argument to ensure proper construction of a configuration API instance.
    */
    ...
    /*
    * Checks the class lives in the set package for configuration API classes.
    *
    * @throws UnsupportedOperationException if API class does not live in configuration API package
    */
