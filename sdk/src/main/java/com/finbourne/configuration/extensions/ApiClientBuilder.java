...
import com.finbourne.configuration.extensions.auth.HttpFinbourneTokenProvider;
import com.finbourne.configuration.extensions.auth.RefreshingTokenProvider;
import com.finbourne.configuration.extensions.auth.FinbourneToken;
...
public class ApiClientBuilder {
    ...
    * for communicating with configuration via the APIs
    *
    ...
    *
    * @param apiConfiguration configuration to connect to configuration API
    * @return
    *
