...
* token expiry to ensure continued connectivity to configuration API without the need
...
public class RefreshingTokenProvider {
    ...
    * that manages direct authentication with configuration.
    *
    * @param httpFinbourneTokenProvider underlying provider that manages explicit authentication calls to configuration
    */
