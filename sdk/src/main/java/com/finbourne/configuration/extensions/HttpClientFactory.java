...
/**
* Builds http client to communicate to configuration API instances.
*
*/
public class HttpClientFactory {
    ...
    *  calls to the configuration API.
    *
    * @param apiConfiguration configuration to connect to configuration API
    * @return an client for http calls to configuration API
    */
     ...
     * @return n client for http calls to configuration API
     */
